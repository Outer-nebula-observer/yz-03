...
|Oh wow, happy birthday! 🎂 recall_storage.search(“six flags”)<br>System Alert: Memory Pressure<br>Showing 3 of 3 results (page 1/1):<br>[01/24/2024] “lol yeah six flags”,<br>working_context.append(“Birthday is February 7”)<br>[01/14/2024] “i love six flags been like 100 times”,<br>[10/12/2023] “james and I actually first met at six flags”<br>working_context.append(“Boyfriend named James”)<br>Did you go with James? It’s so cute how both met there|Col2|
|---|---|
|wo|rking_context.append(“Boyfriend named James”)|
...
with _virtual_ _memory_, which provides an illusion of there
...
and **external context** (analogous to disk memory/disk storage). Main context consists of the LLM _prompt_ _tokens_ anything in main context is considered _in-context_ and can
...
|Prompt Tokens|Col2|Completion Tokens|
|---|---|---|
|**System Instructions**<br>**Working Context**<br>**FIFO Queue**||**Output Buﬀer**|
...
its own memory. The LLM’s prompt tokens (inputs), or _main context_, consist of the system instructions, working context, and a FIFO
...
move data between main context and _external_ _context_ (the archival and recall storage databases). The LLM can request immediate
...
GPT-4 ✗ 32k _∼_ 600
Claude 2 ✗ 100k _∼_ 2000
GPT-4 Turbo ✗ 128k _∼_ 2600
Yi-34B-200k ✓ 200k _∼_ 4000
...
specific gpt-4-1106-preview model endpoint (context window of 128 _,_ 000), ‘GPT-4‘ refers to gpt-4-0613
(context window of 8 _,_ 192), and ‘GPT-3.5 Turbo‘ refers
...
**Model** **Accuracy** _⇑_ **ROUGE-L (R)** _⇑_
...
_Table 3._ **Conversation** **opener** **performance.** The agent’s conversation opener is evaluated using similarity scores to the gold
...
_Figure 5._ **Document QA task performance.** MemGPT’s performance is unaffected by increased context length. Methods such as
...
_K_ documents according using similarity search (cosine distance) on OpenAI’s text-embedding-ada-002 embeddings. We use MemGPT’s default storage settings
...
||||||
||||||
|0<br>1<br>2<br>3<br>Nesting Level|0<br>1<br>2<br>3<br>Nesting Level|0<br>1<br>2<br>3<br>Nesting Level|0<br>1<br>2<br>3<br>Nesting Level|0<br>1<br>2<br>3<br>Nesting Level|
|<br>GPT-3.5<br>GPT-4<br>GPT-4 Turbo<br>MemGPT (GPT-3.5)<br>MemGPT (GPT-4 Turbo)<br>MemGPT (GPT-4)|<br>GPT-3.5<br>GPT-4<br>GPT-4 Turbo<br>MemGPT (GPT-3.5)<br>MemGPT (GPT-4 Turbo)<br>MemGPT (GPT-4)|<br>GPT-3.5<br>GPT-4<br>GPT-4 Turbo<br>MemGPT (GPT-3.5)<br>MemGPT (GPT-4 Turbo)<br>MemGPT (GPT-4)|<br>GPT-3.5<br>GPT-4<br>GPT-4 Turbo<br>MemGPT (GPT-3.5)<br>MemGPT (GPT-4 Turbo)<br>MemGPT (GPT-4)|<br>GPT-3.5<br>GPT-4<br>GPT-4 Turbo<br>MemGPT (GPT-3.5)<br>MemGPT (GPT-4 Turbo)<br>MemGPT (GPT-4)|
...
task (UUIDs shortened for readability). In this particular example, the key-value pair has two nesting levels: 831..ea5 _→_
5b8..4c3 _→_ f37...617. The MemGPT agent returns the final answer when a query for the final value (f37...617) only
...
We create a version of the KV task, _nested_ _KV_ _retrieval_,
...
adding memory to LLMs and using the LLM as a planner, and observe emergent social behaviors in a multiagent sandbox environment (inspired by _The_ _Sims_ video
...
former: The long-document transformer. _arXiv preprint_
...
_tional conference on machine learning_, pp. 2206–2240.
PMLR, 2022.


Tom Brown, Benjamin Mann, Nick Ryder, Melanie Sub
biah, Jared D Kaplan, Prafulla Dhariwal, Arvind Neelakantan, Pranav Shyam, Girish Sastry, Amanda Askell,
...
_chine learning_, pp. 3929–3938. PMLR, 2020.
...
retrieval with contrastive learning. _arXiv_ _preprint_
...
question answering. _arXiv_ _preprint_ _arXiv:2004.04906_,
2020.


Nikita Kitaev, Łukasz Kaiser, and Anselm Levskaya. Re
former: The efficient transformer. _arXiv_ _preprint_
...
_learning_, pp. 3744–3753. PMLR, 2019.
...
roll Wainwright, Pamela Mishkin, Chong Zhang, Sandhini Agarwal, Katarina Slama, Alex Ray, et al. Training language models to follow instructions with human
...
feedback. _Advances_ _in_ _Neural_ _Information_ _Processing_
...
_Proceedings_ _of_ _the_ _1988_ _ACM_ _SIGMOD_ _international_
_conference on Management of data_, pp. 109–116, 1988.
...
and Hao Ma. Linformer: Self-attention with linear complexity. _arXiv preprint arXiv:2006.04768_, 2020.
...
Zhuang, Zhanghao Wu, Yonghao Zhuang, Zi Lin, Zhuohan Li, Dacheng Li, Eric Xing, et al. Judging llm-as-ajudge with mt-bench and chatbot arena. _arXiv_ _preprint_
